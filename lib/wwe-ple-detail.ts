...
export const PLE_EVENT_DETAILS: Record<PleSlug, PleEventDetail> = {
  ...
  "bash-in-berlin": {
    slug: "bash-in-berlin",
    tagline: "유럽의 밤, 국제 팬과 함께하는 스펙터클",
    layout: "international",
    signatureLabel: "베를린 스페셜",
    theme: {
      pageBg: "bg-stone-950",
      heroGradient: "from-sky-950/50 via-stone-900 to-stone-950",
      accent: "text-sky-300",
    ...
    highlights: [
      { title: "해외 개최", detail: "독일 베를린 아레나 규모의 라이브" },
      { title: "국제 스타", detail: "유럽 출신·글로벌 페우드 강조" },
      { title: "특별 입장", detail: "현지 문화를 반영한 연출" },
    ],
    predictionFocus: ["메인 이벤트 승자", "현지 선수 각", "챔피언 방어"],
  },
  "bad-blood": {
    slug: "bad-blood",
